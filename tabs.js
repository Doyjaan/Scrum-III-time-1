...
function loadEmpresas() {
    document.getElementById('content').innerHTML = `
        <div id="Empresas" class="tabcontent active">
            ...
            <p id="empresaMessage" style="display:none;color:green;">Empresa cadastrada com sucesso!</p>
        </div>
    `;
...
function loadONGs() {
    document.getElementById('content').innerHTML = `
        <div id="ONGs" class="tabcontent active">
            ...
            <p id="ongMessage" style="display:none;color:green;">ONG cadastrada com sucesso!</p>
        </div>
    `;
